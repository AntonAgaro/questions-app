...
/* harmony import */ var _modules_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/utils */ "./app/js/modules/utils.js");
/* harmony import */ var _modules_question__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/question */ "./app/js/modules/question.js");
...
var input = form.querySelector('#question-input');
var submitBtn = form.querySelector('#submit');
window.addEventListener('load', _modules_question__WEBPACK_IMPORTED_MODULE_4__["Question"].renderList);
form.addEventListener('submit', submitFormHandler);
input.addEventListener('input', function () {
  submitBtn.disabled = !Object(_modules_utils__WEBPACK_IMPORTED_MODULE_3__["isValid"])(input.value);
});

function submitFormHandler(e) {
  e.preventDefault();

  if (Object(_modules_utils__WEBPACK_IMPORTED_MODULE_3__["isValid"])(input.value)) {
    var question = {
      text: input.value.trim(),
      date: new Date().toJSON()
    };
    submitBtn.disabled = true; //Async request to server to save question

    _modules_question__WEBPACK_IMPORTED_MODULE_4__["Question"].create(question).then(function () {
      input.value = '';
      input.className = '';
...
var Question = /*#__PURE__*/function () {
  ...
  _createClass(Question, null, [{
    ...
    value: function create(question) {
      return fetch('https://anton-questions-app-default-rtdb.firebaseio.com/questions.json', {
        method: 'POST',
    ...
    value: function renderList() {
      var questions = getQuestionsFromLocalStorage();
      var html = questions.length ? questions.map(toCard).join('') : "<div class=\"mui--text-headline\">\u0412\u044B \u043F\u043E\u043A\u0430 \u043D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u0441\u043F\u0440\u0430\u0448\u0438\u0432\u0430\u043B\u0438</div>";
...
function addToLocalStorage(question) {
  var all = getQuestionsFromLocalStorage();
  all.push(question);
...
function toCard(question) {
  return "\n    <div class=\"mui--text-black-54\">\n    ".concat(new Date(question.date).toLocaleDateString(), "\n    ").concat(new Date(question.date).toLocaleTimeString(), "\n    </div>\n    <div>").concat(question.text, "</div>\n    <br>\n    ");
}
